/* TP01P2Q04 - Fila Circular com Alocacao Sequencial
...
public class FilaCircular
{
  ...
  * @param elem Instituicao elemento a ser inserido.
  * */
  public void inserir (Instituicao elem) throws Exception
  {
   //validar entrada
    if (numEl == t)
    {
  ...
  * @return resp Instituicao elemento a ser removido.
  ...
  * */
  public int somarMedia ()
  {
     ...
     //somar Despesas Docente de cada elemento na fila
      while (controle < numEl)
      {
        soma = soma + ((array[i]).getDespesaDocente ());
        i = ((i+1)%t);
        controle++;
      }//fim while
      soma = soma/numEl;
