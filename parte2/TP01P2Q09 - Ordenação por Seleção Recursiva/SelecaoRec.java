/* TP01P2Q09 - Ordenacao por Selecao Recursiva
...
/*
 * Algoritmo que chama a ordenacao por selecao recursiva
 * */
   public void ordemSelecaoRec ()
   {
    int i = 0;
    int j = 1;
    ordemSelecaoRec (i);
 ...
 /*
 * Algoritmo de ordenacao por selecao parcialmente recursivo
 * */
   public void ordemSelecaoRec (int i)
   {
      if ( i >= 0 && i < (n-1))
      {
         int menor = i;
 ...
 * ate 10 elementos funciona
 * acima disso esta dando TIMEOUT
 * */
   public void ordemSelecaoRec (int i, int j)
   {
      if (i >= 0 && i < (n-1))
      {
         int menor = i;
         if (j < n)
          {
            if ((array[menor]).getCodigo () >
             ...
             ordemSelecaoRec (menor, j+1);
          }//fim if
            swap (menor, i);
            ordemSelecaoRec (i+1, i+1);
      }//fim if
   }//fim ordemSelecao
 ...
 //main
  public static void main (String [] args)
  {
   ...
   try {
    SelecaoRec lista = new SelecaoRec (200);
   //abrir arquivo
    FileWriter arquivo = new FileWriter ("628510_selecaoRecursiva.txt");
