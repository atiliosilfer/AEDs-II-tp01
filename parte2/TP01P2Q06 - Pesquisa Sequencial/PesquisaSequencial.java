...
public class PesquisaSequencial
{
  ...
  * */
  public PesquisaSequencial (int tamanho)
  {
 ...
 * */
 ...
 //main
  public static void main (String [] args)
  {
   ...
   try {
    PesquisaSequencial lista = new PesquisaSequencial (200);
   //abrir arquivo
    FileWriter arquivo = new FileWriter ("628510_sequencial.txt");
